...
def convert_warc_to_dataframe(warc_file_location):
    ...
    """
    try:
        warc_file_location = check_warc_format_and_get_updated_location(warc_file_location)
        warc_file = open(warc_file_location, "rb")
        warc_file_it = warc.ArchiveIterator(warc_file)
        warc_items = get_warc_items(warc_file_it)
...
def check_warc_format_and_get_updated_location(warc_file_location):
    ...
    """
    if warc_checker.is_warc_file_in_correct_format(warc_file_location):
    ...
    warc_file_location = warc_checker.recompress_warc_file_in_correct_format(warc_file_location)
